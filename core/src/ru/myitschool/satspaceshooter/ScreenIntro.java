...
public class ScreenIntro implements Screen {
    ...
    public ScreenIntro(MyGG myGG){
        ...
        btnPlay = new TextButton(gg.fontLarge, "ИГРАТЬ", 100, 450);
        btnSettings = new TextButton(gg.fontLarge, "НАСТРОЙКИ", 100, 350);
        btnAbout = new TextButton(gg.fontLarge, "ОБ ИГРЕ", 100, 250);
        btnExit = new TextButton(gg.fontLarge, "ВЫХОД", 100, 150);
    }
